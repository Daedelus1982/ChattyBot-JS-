...
function test() {
    ...
    console.log("What does CI mean?");
    console.log("1. Continuous Input");
    console.log("2. Convenient Integration");
    console.log("3. Continuous Integration");
    console.log("4. Conflabs Internals");
